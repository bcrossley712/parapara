...
import { showUpdatePrompt } from './ui/ui.js';

document.getElementById('app').innerHTML = `
  <div style="display:flex;align-items:center;justify-content:center;height:100vh;font-family:system-ui;color:#333;">
    <p>Parapara! — under construction</p>
  </div>
`;
